...
// it("SoftlawLicenses- EVM: Can mint collection for free and mint tokens for free after that", async () => {
...
//   const MinterFactory = await ethers.getContractFactory("SoftlawLicenses");
